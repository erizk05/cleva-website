          ...
          <div class="carousel-container" style="margin-bottom: var(--space-6);">
            <div class="modal-carousel" id="modal-carousel">
              <div class="modal-carousel-item" style="height: 350px;">
                <img src="${v.id === 'etrike-tt' ? './assets/images/etrike-tt.png' : 'https://placehold.co/800x600/2a2a2a/ffffff?text=Front+Angle'}" alt="${v.name} Front Angle" style="object-fit: contain; width: 100%; height: 100%;" />
              </div>
              <div class="modal-carousel-item" style="height: 350px;">
                <img src="${v.id === 'etrike-tt' ? './assets/images/etrike-tt-2.png' : 'https://placehold.co/800x600/2a2a2a/ffffff?text=Right+Side+Angle'}" alt="${v.name} Right Side Angle" style="object-fit: contain; width: 100%; height: 100%;" />
              </div>
              <div class="modal-carousel-item" style="height: 350px;">
                <img src="${v.id === 'etrike-tt' ? './assets/images/etrike-tt-3.png' : 'https://placehold.co/800x600/2a2a2a/ffffff?text=Left+Side+Angle'}" alt="${v.name} Left Side Angle" style="object-fit: contain; width: 100%; height: 100%;" />
              </div>
              <div class="modal-carousel-item" style="height: 350px;">
              ...
              <div class="modal-carousel-item" style="height: 350px;">
                <img src="${v.id === 'etrike-tt' ? './assets/images/etrike-tt-4.png' : 'https://placehold.co/800x600/2a2a2a/ffffff?text=Whole+View'}" alt="${v.name} Whole View" style="object-fit: contain; width: 100%; height: 100%;" />
              </div>
            </div>
